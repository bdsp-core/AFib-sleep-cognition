...
def my_spindle_detect(signals, sleep_stages, Fs, ch_names, include=None, freq_sp=[11,16], thresh={'corr':0.65, 'rel_pow':0.2, 'rms':1.5}, verbose=False, rel_pow_all=None, mcorr_all=None, mrms_all=None, return_precomputed=False, compute_sp_char=True, return_filtered_signal=False):
    #amp = thresh.pop('amp')
