...
def main():
    ...
    cols = ['POSTDYDT', 'POAHI3', 'POAVGPLM', 'POPCSA90', 'POAI_ALL', 'POSLPRDP', 'POWASO', 'POTMST1P', 'POTMST2P', 'POTMS34P', 'POTMREMP', 'POTMST1', 'POTMST2', 'POTMST34', 'POTMREM']
    cols2 = ['date_PSG', 'M_AHI3', 'M_PLMI', 'M_POPCSA90', 'M_AI', 'M_macro_TST', 'M_macro_WASO', 'M_macro_N1Perc', 'M_macro_N2Perc', 'M_macro_N3Perc', 'M_macro_REMPerc', 'M_macro_N1Time', 'M_macro_N2Time', 'M_macro_N3Time', 'M_macro_REMTime']
    ...
    feat_cols = [x for x in df_vs1_sleep.columns if x.split('_')[0] in ['bp','sp','sw','EMG','REM','HB']]#,'log' CPC is not accurate in AFib
